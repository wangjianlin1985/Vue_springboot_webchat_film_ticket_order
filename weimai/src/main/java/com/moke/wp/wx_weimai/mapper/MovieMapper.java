...
public interface MovieMapper extends BaseMapper<Movie> {
    ...
    void upWish(@Param("movieId") Integer movieId,@Param("num") Integer num);
    ...
    List<Movie> getLikeMovieList(@Param("movieId") Integer movieId, @Param("cat") String cat,@Param("limit") Integer limit);
