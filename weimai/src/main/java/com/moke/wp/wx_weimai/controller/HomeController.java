...
public class HomeController {
    ...
    public Result search(@RequestParam("keyword") String keyword,
        ...
        if(stype == -1){
        	...
        	PageBean<Movie> moviePageBean = moviceService.getMovies(1,1000,keyword);
        	List<Movie> movies = moviePageBean.getBeanList();
    ...
    private List<CinemaVo> searchCinema(String keyword,SelectCity cityInfo){
        ...
        */
        ...
        PageBean<AdminCinema> page2 = cinemaService.getCinema(1, 1000, keyword);
        List<AdminCinema> cinemas = page2.getBeanList();
